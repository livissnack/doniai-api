...
module.exports = {
  config: {
    //   https://kyfw.12306.cn/otn/leftTicket/queryT?leftTicketDTO.train_date=2019-10-01&leftTicketDTO.from_station=SZQ&leftTicketDTO.to_station=QRN&purpose_codes=ADULT
    queryUrl: Env.get("TICKET_URL", `${BaseUrl}/otn/leftTicket/queryT`),
    ...
    priceUrl: Env.get("TICKET_PRICE_URL", `${BaseUrl}/otn/leftTicket/queryTicketPrice`),
